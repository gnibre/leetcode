...
class Solution(object):
    ...
    def largestDivisibleSubset(self, nums):
        ...
        for x in sorted(nums):
            ...
            # list_comprehensive = [[workshop[dv][0], dv] for dv in workshop if x % dv == 0]
            # print "list_comprehensive  %r " % list_comprehensive
            max_lenght_tup = max([[workshop[dv][0], dv] for dv in workshop if x % dv == 0])
            if not max_lenght_tup:
                continue

            # print "max_lenght_tup    len, successor, dv_itself.   %r " % max_lenght_tup

            workshop[x] = [max_lenght_tup[0] + 1, max_lenght_tup[1]]
            # print "workshop[x] : %r " % workshop[x]
        ...
        print "current_max_set_size   %d " % mxs
